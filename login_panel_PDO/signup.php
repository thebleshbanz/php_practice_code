...
if (isset($_POST['submit'])){
	...
	if (empty($_POST["mobile"])) {
		...
		$error['mobile'] = "numeric are not allowed";
	}
	...
	}elseif (!empty($obj->unique_email($_POST["email"]))){
	...
	<div class="rows col-md-6">
	  ...
	  <form class="form-horizontal" method="post" 
	    ...
	    <div class="form-group">
	      ...
	      <input type="email" class="form-control" name="email" id="email" placeholder="Enter email" value="<?php echo isset($_POST['email'])?$_POST['email']:''; ?>">
	    </div>
...
<div class="form-group">
	...
	<span class="error">* <?php echo isset($error['education'])?$error['education']:'';?></span>
		<select class="form-control" name="education[]" multiple="" size="2">
			<option>please select education</option>
			<option value="1"
			<?php if (isset($_POST['education'])?in_array(1, $_POST['education']):'' ) { echo "selected='selected'";	} ?>
			  >10th</option>
			<option value="2"
			<?php if (isset($_POST['education'])?in_array(2, $_POST['education']):'') { echo "selected='selected'";	} ?>
			>12th</option>
			<option value="3"
			<?php if (isset($_POST['education'])?in_array(3, $_POST['education']):'') { echo "selected='selected'";	} ?>
			>UG</option>
			<option value="4"
			<?php if (isset($_POST['education'])?in_array(4, $_POST['education']):'') { echo "selected='selected'";	} ?>
			>PG</option>			  		  
		</select> 
</div>
	     ...
	     <div class="form-group">
		    ...
		    <?php //echo isset($_POST['usertype'])?$_POST['usertype']:''; ?>   
		    <br>
		  </div>  
