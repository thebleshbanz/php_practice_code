...
$conn = dbconn();
$get_product=get_product($conn, $_POST);
//echo "<pre>"; print_r($get_product);die;
	...
	<div class="rows col-md-6">
	  ...
	  <form class="form-horizontal" method="post" 
	    ...
	    <div class="form-group">
	      ...
	      <input type="file" name="photo" value="<?php echo $image; ?>">
		  <img src="<?php echo img_path;echo $image; ?>" alt="iamge" height="40px" width="50px">
	    </div>	    
