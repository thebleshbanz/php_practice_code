	...
	<div class="rows col-md-6">
	  ...
	  <form class="form-horizontal" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" enctype='multipart/form-data'>
		...
		<div class="form-group">
	      ...
	      <input type="number" class="form-control" name="quantity" value="<?php isset($_POST['quantity'])?$_POST['quantity']:''; ?>" placeholder="Enter Quantity No." value="<?php //echo isset($_POST['quantity'])?$_POST['quantity']:'';?>">
	    </div>
		
		<div class="form-group">
	      <label for="rate">Rate of Product:</label>
	      <span class="error">* <?php echo isset($error['rate'])?$error['rate']:'';?></span>
	      <input type="number" class="form-control" name="rate" value="<?php isset($_POST['quantity'])?$_POST['quantity']:''; ?>"placeholder="Enter Rate No." value="<?php //echo isset($_POST['rate'])?$_POST['rate']:'';?>">
	    </div>	 
		
		<div class="form-group">
			<label for="color">Product Color:</label>
			<span class="error">* <?php echo isset($error['color'])?$error['color']:'';?></span>
				<select class="form-control" name="color" value="<?php echo $_POST['color']; ?>" size="2">
